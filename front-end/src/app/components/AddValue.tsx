    ...
    return (
        <div className={styles.addValue}>
            ...
            <div className={styles.input}>
                ...
                <Input type='number' getValue={(value) => setAmount(parseInt(value))} placeholder='Valor' onKeyDown={handleEnterKey}/>
            </div>
            <div className={styles.flexRow}>
                <textarea name="" id="" cols={30} rows={2} maxLength={150} placeholder='Notas' onChange={(e) => setNotes(e.target.value)}></textarea>
